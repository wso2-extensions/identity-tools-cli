...
const SCOPE string = "internal_application_mgt_update internal_application_mgt_create internal_application_mgt_view internal_idp_update internal_idp_create internal_idp_view internal_claim_meta_create internal_claim_meta_view internal_claim_meta_update"
